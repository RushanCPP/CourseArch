...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        variants.add("Три");
        variants.add("Четыре");
        TestTask testTask = new TestTask("Сколько?", new ConsoleTestTaskDisplayBehavior(), 2, variants);
        Lesson lesson = new TaskLesson("2.4.1", testTask, new ConsoleTaskLessonDisplay());
        Lesson lesson1 = new StudyLesson("Отрицательные числа", "\tЭкономист - это плохо\n\tФизик - это ответ", new ConsoleStudyLessonDisplay());
        ...
        TestTask testTask1 = new TestTask("Сколько?v2.0", new ConsoleTestTaskDisplayBehavior(), 2, variants1);
        Lesson lesson11 = new TaskLesson("2.4.1", testTask1, new ConsoleTaskLessonDisplay());
